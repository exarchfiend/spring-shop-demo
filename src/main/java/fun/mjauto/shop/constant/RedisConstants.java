...
public class RedisConstants {
    public static final String GLOBAL_ID_KEY = "shop:global:id:"; // 全局唯一ID开始时间戳
    ...
    public static final String SECKILL_STOCK_ORDER = "shop:seckill:order:";  // 秒杀优惠券库存 key
    public static final String SECKILL_STREAM_KEY = "shop:stream.orders";  // 秒杀优惠券订单消息队列 key
    public static final String SECKILL_STREAM_GROUP_NAME = "voucher";  // 秒杀优惠券订单消费组名称
